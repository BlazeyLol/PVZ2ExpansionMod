...
#define STAGEMODULE_CONSTRUCT_ADDR 0x31DEE8
#define STAGEMODULE_GETCLASS_ADDR 0x4B1CFC
#define STAGEMODULE_VTBL 0x1C717C8
...
public:
	...
	int unk;
	Sexy::RtWeakPtr<Sexy::RtObject> m_backImage;
	Sexy::RtWeakPtr<Sexy::RtObject> m_backImageRight;
	Sexy::RtWeakPtr<Sexy::RtObject> m_backImageLeft;
	char pad0060[0x30];
